...
export const KeyFeaturesSection = () => {
  ...
  return (
    <section className="w-full py-8 md:py-16 px-4 relative">
      <h2 className="font-bold text-[28px] md:text-4xl mb-6 font-['Atkinson_Hyperlegible',Helvetica] text-center">
        KEY FEATURES
      </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div key={index} className="relative flex flex-col items-center">
              ...
              <h3 className="[font-family:'Inter',Helvetica] font-extrabold text-[#3dfe90] text-lg md:text-xl mb-4 text-center">
                {feature.title}
              </h3>

              <p className="[font-family:'Inter',Helvetica] font-medium text-white text-sm md:text-base text-center md:text-justify">
                {feature.description}
              </p>
            </div>
          ))}
      ...
      <div className="flex flex-col items-center mt-16">
        <Button className="bg-[#3dfe90] text-black hover:bg-[#3dfe90]/90 rounded-[26px] h-[98px] w-full max-w-[478px] mb-5">
          <span className="[font-family:'Inter',Helvetica] font-semibold text-[28px]">
            Schedule for a Demo Now
          </span>
        </Button>

        <p className="[font-family:'Inter',Helvetica] font-medium text-[#2c00ca] text-[27px]">
