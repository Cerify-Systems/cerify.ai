  ...
  return (
    <section className="relative w-full mx-auto">
      ...
      <div className="relative w-full h-[580px] md:h-[750px] -mt-[81px] pt-[81px]">
        ...
        <div 
          className="absolute inset-0 bg-cover bg-[50%_50%] opacity-10 rounded-[0px_0px_26px_26px]"
          style={{ backgroundImage: 'url(/figmaAssets/main-bg.png)' }}
        ></div>
        {/* Content layer */}
        <div className="relative z-10 w-full h-full">
          <div className="flex flex-col items-center justify-center pt-[100px] md:pt-[197px] px-4">
          <h1 className="w-full max-w-[872px] font-bold text-[#2c00ca] text-[32px] md:text-[64px] text-center leading-[40px] md:leading-[80px] [font-family:'Atkinson_Hyperlegible',Helvetica]">
            Deploy Smart Contracts with Confidence
          </h1>

          <div className="w-full max-w-[895px] mt-[20px] md:mt-[42px] text-center px-4">
            <p className="[font-family:'Inter',Helvetica]">
          ...
          <Button className="mt-[30px] md:mt-[40px] h-[60px] md:h-[70px] w-[240px] md:w-[280px] bg-[#3dfe90] rounded-[26px] hover:bg-[#3dfe90]/90">
            <span className="font-semibold text-black text-[18px] md:text-[24px] [font-family:'Inter',Helvetica]">
              Get Beta Access
            </span>
          </Button>
          </div>
      ...
      <div className="w-full min-h-[294px] bg-[#2c00ca] relative -mt-[26px]">
        <div className="flex flex-col md:flex-row justify-start items-start px-4 md:px-[77px] py-8 md:py-11 gap-8 md:gap-0">
          {statistics.map((stat, index) => (
            ...
            >
              <div
                className="[font-family:'Inter',Helvetica] font-semibold text-[#3dfe90] text-3xl md:text-5xl tracking-[0] leading-[normal] mb-4 md:mb-6"
              >
                {stat.value}
              </div>
              <div
                className="[font-family:'Inter',Helvetica] font-normal text-white text-sm md:text-base tracking-[0] leading-[normal] max-w-[280px] md:max-w-none mx-auto md:mx-0"
              >
                {stat.description}
              </div>
            </div>
      ...
      <div className="flex flex-col md:flex-row mt-[40px] md:mt-[68px] px-4 md:px-[92px] gap-8 md:gap-[101px]">
        <div className="w-full md:w-[489px]">
          <p className="[font-family:'Inter',Helvetica] text-[20px] md:text-[26px] tracking-[0] leading-[normal]">
              ...
              <CardContent className="flex items-center p-0">
                <div className="flex items-center gap-[15px] md:gap-[22px] px-4 md:px-[37px] py-2.5 w-full">
                  <img
                    ...
                    src={feature.icon}
                  />
                  <div className="flex-1 [font-family:'Inter',Helvetica] font-normal text-white text-sm md:text-xl tracking-[0] leading-[normal]">
                    {feature.text}
                  </div>
                </div>
              </CardContent>
