                ...
                <Table>
                  <TableHeader>
                    <TableRow className="bg-[#2c00ca]/5 border-b-2 border-[#2c00ca]/20">
                      <TableHead className="py-6 px-6 font-bold text-lg text-[#2c00ca] font-['Inter',Helvetica]">
                        Feature
                      </TableHead>
                      ...
                      <TableHead className="py-6 px-4 font-bold text-base text-gray-600 font-['Inter',Helvetica] text-center">
                        CertiK
                      </TableHead>
                      <TableHead className="py-6 px-4 font-bold text-base text-gray-600 font-['Inter',Helvetica] text-center">
                        Mythril
                  ...
                  <TableBody>
                    {features.map((feature, index) => (
                      <TableRow key={index} className={`${index % 2 === 0 ? 'bg-white' : 'bg-gray-50/50'} border-b border-gray-200/50 hover:bg-[#2c00ca]/5 transition-colors`}>
                        <TableCell className="py-5 px-6 font-semibold text-base text-[#2c00ca] font-['Inter',Helvetica]">
                          {feature.name}
                        </TableCell>
                        <TableCell className="py-5 px-4 font-semibold text-base text-center font-['Inter',Helvetica]">
                          <span className={`${feature.cerify.includes('✅') ? 'text-green-600' : feature.cerify.includes('❌') ? 'text-red-500' : 'text-[#2c00ca]'}`}>
                            {feature.cerify}
                          </span>
                        </TableCell>
                        <TableCell className="py-5 px-4 font-medium text-sm text-center font-['Inter',Helvetica]">
            ...
            {features.map((feature, index) => (
              <Card key={index} className="border-2 border-[#2c00ca]/20 rounded-[20px] overflow-hidden shadow-md">
                <CardContent className="p-6">
                  <h4 className="font-bold text-lg text-[#2c00ca] font-['Inter',Helvetica] mb-4 text-center">
                    {feature.name}
                  </h4>
