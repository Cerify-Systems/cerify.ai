  ...
  return (
    <section className="relative w-full py-8 md:py-16 px-4">
      <div className="container mx-auto max-w-6xl">
        <h2 className="font-['Atkinson_Hyperlegible',Helvetica] font-bold text-black text-[24px] md:text-[32px] tracking-[0] leading-normal mb-4 text-center">
          FROM UPLOAD TO CERTIFICATION IN MINUTES
        </h2>
        <h3 className="font-['Inter',Helvetica] font-semibold text-[#2c00ca] text-lg md:text-xl tracking-[0] leading-normal mb-12 text-center">
          How Does It Work ?
        </h3>
          ...
          {processSteps.map((step, index) => (
            ...
            >
              ...
              <div className={`absolute px-4 lg:px-8 ${
                ...
                <h4 className="font-['Inter',Helvetica] font-semibold text-[#2c00ca] text-sm lg:text-base mb-1 lg:mb-2">
                  {step.title}
                </h4>
                <p className="font-['Inter',Helvetica] font-medium text-[#2c00ca] text-xs lg:text-sm leading-tight lg:leading-relaxed">
                  {step.description}
                </p>
              </div>
            </div>
