  ...
  return (
    <section className="relative w-full py-16 flex flex-col items-center">
      ...
      <div className="relative w-full max-w-[1440px] flex flex-col items-center">
        {/* Heading */}
        <h2 className="font-bold text-[#2c00ca] text-[64px] text-center [font-family:'Atkinson_Hyperlegible',Helvetica]">
          Ready to Deploy Fearlessly?
        </h2>

        {/* Subheading */}
        <p className="mt-7 text-[27px] text-center [font-family:'Inter',Helvetica]">
        ...
        <Card className="mt-8 w-[480px] bg-white rounded-[50px] border-4 border-solid border-[#2c00ca]">
          <CardContent className="flex flex-col items-center gap-[31px] px-[27px] py-3.5">
            <h3 className="w-[266px] [font-family:'Inter',Helvetica] font-bold text-[#2c00ca] text-2xl">
              Beta Program Benefits
            </h3>

            <div className="w-[416px] [font-family:'Inter',Helvetica] font-medium text-black text-base text-center">
        ...
        <Button className="mt-16 px-[47px] py-8 bg-[#3dfe90] rounded-[26px] hover:bg-[#3dfe90]/90">
          <span className="font-semibold text-black text-[28px] [font-family:'Inter',Helvetica]">
            Get Beta Access
          </span>
        </Button>

        {/* Footer text */}
        <p className="mt-6 font-semibold text-black text-[27px] [font-family:'Inter',Helvetica]">
